...
using ServiceDotnet.Infrastructure;
using ServiceDotnet.Infrastructure.Models;

namespace ServiceDotnet;
...
public class SeedDevelopmentData
{
    ...
    {
        var context = serviceProvider.GetRequiredService<ServiceDotnetDbContext>();
