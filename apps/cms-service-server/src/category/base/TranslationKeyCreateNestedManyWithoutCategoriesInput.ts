...
@InputType()
class TranslationKeyCreateNestedManyWithoutCategoriesInput {
...
export { TranslationKeyCreateNestedManyWithoutCategoriesInput as TranslationKeyCreateNestedManyWithoutCategoriesInput };
